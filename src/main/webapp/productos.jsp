...
<body>
	...
	<main>
		...
		<nav class="contenedor">
			<div class="opcion">
				<h2>Inicio</h2>
				<a href="menu.jsp"> <img src="imagenes/house-1110868_1280.png"
					alt="Reportes">
				</a>
			</div>
			<div class="opcion">
				<h2>Usuarios</h2>
				<a href="Usuarios.jsp"> <img src="imagenes/usuarios.png"
					alt="Usuarios">
				</a>
			</div>
			<div class="opcion">
				<h2>Clientes</h2>
				<a href="clientes.jsp"> <img src="imagenes/clientes.png"
					alt="Clientes">
				</a>
			</div>
			<div class="opcion">
				<h2>Proveedores</h2>
				<a href="proveedores.jsp"> <img src="imagenes/proveedoress.png"
					alt="Proveedores">
				</a>
			</div>
			<div class="opcion">
				<h2>Productos</h2>
				<a href="productos.jsp"> <img
					src="imagenes/donut-1727493_1920.png" alt="productos">
				</a>
			</div>
			<div class="opcion">
				<h2>Reportes</h2>
				<a href="reportes.jsp"> <img
					src="imagenes/symbol-2444430_1280.png" alt="Reportes">
				</a>
			</div>
			<div class="opcion">
				<h2>Ventas</h2>
				<a href="ventas.jsp"> <img
					src="imagenes/shopping-cart-1105049_1280.png" alt="Reportes">
			...
			<div class="opcion">
				...
				<a href="index.jsp"> <img
					src="imagenes/log-out-2355227_1280.png" alt="Reportes">
				</a>
			</div>
		</nav>
	</main>
	...
	<nav class="usuarios">
		<div id="formulario" class="formulario">
			...
			<form action="ServletProductos" method="POST" enctype="multipart/form-data">
				...
				<input type="text" name="nom" value="<%=nombre_producto != null ? nombre_producto: ""%>"
					placeholder="Nombre">
				<p>Nit Proveedor :</p>
				<input type="search" name="nit" value="<%=nit_proveedor != null ? nit_proveedor: ""%>"
					placeholder="Nit del Proveedor">
				<p>Precio compra :</p>
				<input type="number" name="precio_compra" value="<%=precio_compra != null ? precio_compra: ""%>"
					placeholder="Precio de Compra">
				<p>Iva de Compra :</p>
				<input type="number" name="iva_compra" value="<%=iva_compra != null ? iva_compra: ""%>"
					placeholder="Iva de Compra">
				<p>Precio de venta :</p>
				<input type="number" name="precio_venta" value="<%=precio_venta != null ? precio_venta: ""%>"
		...
		<div class="carga">
			<input type="file" name="archivo" class="cheko" value=""> 
			<input type="submit" name="cargar" class="cheko" value="Agregar Archivo">
		</div>
			</form>
		</div>
	</nav>
